<img width=100% src="https://capsule-render.vercel.app/api?type=waving&color=407af6&height=120&section=header"/>

[![Typing SVG](https://readme-typing-svg.herokuapp.com/?color=ffffff&size=35&center=true&vCenter=true&width=1000&lines=Olá,+Eu+sou+Uedson+de+Oliveira;Estudante+de+Desenvolvimento+Full+Stack;Este+é+o+meu+perfil+do+GitHub;Onde+compartilho+meus+projetos+e+experiências;No+mundo+da+programação.)](https://git.io/typing-svg)
...
- 🌱 Formado em Análise e Desenvolvimento de Sistemas[UNOPAR](https://www.unopar.com.br/).
- 🔭 Tenho formação no ano de 2023 em Desenvolvimento Web Full Stack[Reprograme-se / IFES-ES](https://reprograme-se.org.br/).
...
### 🚀 Projetos Destacados
- [Projeto 1](https://laboratoriosoares.com.br/): Site desenvolvido como Freelancer para a empresa API-Soluções.
  - Site para uma clínica médica. Fiz toda a parte de Front end e participei de toda a estrutura até o deploy.
  - O site apresenta informações sobre os serviços oferecidos, sistema para consulta de exames e formas de contato.
    - [clique aqui para conhecer o site](https://laboratoriosoares.com.br/)    

- [Projeto 2](https://uedsonoliveira.github.io/agencia-de-viagens/): Projeto de Landing Page para uma Agência de Turismo(DevMedia).
  ...
  - método / input / label / placeholder / require / select / option / button / submit / radio / checkbox entre outras funções.
    - [clique aqui para conhecer o projeto](https://uedsonoliveira.github.io/agencia-de-viagens/)
 
- [Projeto 3](https://uedsonoliveira.github.io/pousada_secreta/): Projeto de site para uma Pousada(DevMedia).
  ...
  - Foi utilizado / CSS FLEXBOX: conceitos, propriedades, elementos e suas estruturas. E vários outros elementos aprendidos no decorrer do curso.
    - [clique aqui para conhecer o projeto](https://uedsonoliveira.github.io/pousada_secreta/)
